...
| Ship Argus, or code derived from it, inside a **closed-source product** | **Commercial** |
| Run a modified Argus as a **hosted or SaaS service**, without publishing your source | **Commercial** |
...
- **Included:** installation and configuration problems, questions about intended behaviour,
  diagnosis of suspected bugs, guidance on using Argus for your case, and licensing or
...
commercial licence to Argus for their own use, as thanks.
...
*Copyright © 2026 Marco Lombardo. Argus is licensed under AGPL-3.0; commercial licensing is
