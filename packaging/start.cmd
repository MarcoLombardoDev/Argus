@echo off
rem Start Argus, after checking that the executable is the one this archive
rem was built with.
rem
rem The archive ships Argus.exe.sha256 beside the executable. This script
...
if "%ARGUS_SKIP_VERIFY%"=="1" (
    echo %APP%: checksum verification skipped ^(ARGUS_SKIP_VERIFY=1^) 1>&2
    goto :launch
)
...
set "_LAUNCH_TIMEOUT=%ARGUS_LAUNCH_TIMEOUT%"
