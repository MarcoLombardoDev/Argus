...
```powershell
Get-FileHash .\Argus-1.3.0-windows-x64.zip -Algorithm SHA256      # Windows
```

```sh
sha256sum Argus-1.3.0-linux-x64.tar.gz                             # Linux
shasum -a 256 Argus-1.3.0-macos-arm64.zip                          # macOS
```
